  ...
  return (
    <div className="home">
      ...
      <div className="row fullheight ">
            ...
            <div className="info-wrapper">
              ...
              <div className="product-description left-to-right">
                <p>
                  ...
                  than before. With more cushioning underfoot and reduced weight
                  up top, the result is unprecedented energy return and comfort
                </p>
              </div>
        ...
        <div className="col-6 fullheight img-colgray">
