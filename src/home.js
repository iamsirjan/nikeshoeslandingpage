        ...
        <div className="row fullheight slide">
          ...
          <div className="col-6 fullheight img-col">
            ...
            <div className="more-images">
              ...
              <div className="more-images-item bottom-up">
                <img
                  src="https://github.com/trananhtuat/nike-shoes-landing-page/blob/main/assets/zoom-fly-3-mens-running-shoe-XhzpPH%20(1).jpg?raw=true"
                  alt="thumbnail image"
                />
              </div>
              <div className="more-images-item bottom-up">
                <img
                  src="https://github.com/trananhtuat/nike-shoes-landing-page/blob/main/assets/zoom-fly-3-mens-running-shoe-XhzpPH%20(2).jpg?raw=true"
                  alt="thumbnail image"
                />
              </div>
              <div className="more-images-item bottom-up">
                <img
                  src="https://github.com/trananhtuat/nike-shoes-landing-page/blob/main/assets/zoom-fly-3-mens-running-shoe-XhzpPH%20(3).jpg?raw=true"
                  alt="thumbnail image"
                />
              </div>
            </div>
              ...
              <div className="product-info">
                <div className="info-wrapper">
                  ...
                  <div className="product-description left-to-right">
                    <p>
                      The Nike ZoomX Vaporfly NEXT% clears your path to
                      record-breaking speed with a lighter design and faster
                      feel than before. With more cushioning underfoot and
                      reduced weight up top, the result is unprecedented energy
                      return and comfort
                    </p>
                  </div>
                  <div className="button left-to-right">
                  ...
                  <div className="info-wrapper">
                    ...
                    <div className="product-description left-to-right">
                      <p>
                        ...
                        record-breaking speed with a lighter design and faster
                        feel than before. With more cushioning underfoot and
                        reduced weight up top, the result is unprecedented
              ...
              <div className="col-6 fullheight img-col">
                <div className="product-img">
                  <div className="img-wrapper right-to-left">
                    <div className="bounce">
                      <img
                        src="https://github.com/trananhtuat/nike-shoes-landing-page/blob/main/assets/air-zoom-superrep-mens-hiit-class-shoe-ZWLnJW.jpg?raw=true"
                        alt="thumbnail image"
                      />
                    </div>
                  </div>
